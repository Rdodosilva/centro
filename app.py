...
st.markdown("""
    <style>
        ...
        /* BOTÃO SELECIONADO - VERMELHO TRANSLÚCIDO */
...
# 🆕 Total anual (soma de todos os meses)
total_anual_sacos = int(df["Total de Sacos"].sum()) if df["Total de Sacos"].notna().any() else 0
